% An experiment script for the experiment: 100831_348_136_12_40hr_0-1XLB_LN

%% prepare input variable for dictionary learning
%Input:
%   projectPath: project path
%   inputFilePath: input path of file xxx.mzML.dc.mat
%Output:
%   basicVarPath: basic variable output path for dictionary learning
clear all;
projectPath = 'D:\Users\YeuChern\GitHub\IMS_project';
inputFilePath = [ projectPath, '\', 'example\realExp_100831_348_136_12_40hr_0-1XLB_LN\100831_348_136_12,40hr_0-1XLB_LN.mzML_dc.mat' ];
basicVarPath = [ projectPath, '\', 'example\realExp_100831_348_136_12_40hr_0-1XLB_LN\100831_348_136_12_40hr_0_1XLB_LN_vars.mat' ];
exp_100831_348_136_12_40hr_0_1XLB_LN_basicSettings_v2( inputFilePath, basicVarPath );
...
%   basicVarPath
%Output:
%   basicVarPath: modify basic variable to have hyperparameters vectors:
%   lambdaVec, thetaVec, phiVec
clear all;
projectPath = 'D:\Users\YeuChern\GitHub\IMS_project';
basicVarPath = [ projectPath, '\', 'example\realExp_100831_348_136_12_40hr_0-1XLB_LN\100831_348_136_12_40hr_0_1XLB_LN_vars.mat' ];
load( basicVarPath );
lambdaVec = logspace( log10(0.2), log10(20), 5 ); lambdaVec = [0 lambdaVec];
thetaVec = logspace( -4, -2, 5 ); thetaVec = [0 thetaVec];
phiVec = logspace( 5, 8, 5 ); phiVec = [0 phiVec];
save( basicVarPath ); clear all

%% run dictionary learning on all hyperparameters
%In current implementation, I use a function: 
%exp_100831_348_136_12_40hr_0_1XLB_LN_all_hypers_grid_search_v3
%And use a script:
%gen_hypers_grid_searchScript( 'D:\exp20150403', expScript_H_Neg, exp_100831_348_136_12_40hr_0_1XLB_LN_all_hypers_grid_search_v3, 216 )
...
%exp_100831_348_136_12_40hr_0_1XLB_LN_all_hypers_grid_search_v3 for usage.
...
%    results
clear all;
resFolderPath = '/home/ycharn/all_hypers_grid_search_results_neg';
projectPath = '~/IMS_project-master';
resMOLDLPath = [ projectPath, '/', 'example/realExp_100831_348_136_12_40hr_0-1XLB_LN/all_hypers_grid_search_analysis_LN_20150403.mat' ];
basicVarPath = [ projectPath, '/', 'example/realExp_100831_348_136_12_40hr_0-1XLB_LN/100831_348_136_12_40hr_0_1XLB_LN_vars.mat' ];
...
exp_100831_348_136_12_40hr_0_1XLB_LN_NNMF( basicVarPath, outFilePath );

%% run sparse-pLSA on data
projectPath = '~/IMS_project-master';
basicVarPath = [projectPath, '/', 'example/realExp_100831_348_136_12_40hr_0-1XLB_LN/100831_348_136_12_40hr_0_1XLB_LN_vars.mat'];
outFilePath = [projectPath, '/', 'example/realExp_100831_348_136_12_40hr_0-1XLB_LN/res_pLSA_20150403.mat'];
exp_100831_348_136_12_40hr_0_1XLB_LN_pLSA( basicVarPath, outFilePath );
...
disp(listing(tIdx+2).name); %exp_100831_348_136_12_40hr_0_1XLB_LN_res_v3_3_.mat
%load( [resFolderPath '/' listing(tIdx+2).name] );
%load the result directly
load( 'exp_100831_348_136_12_40hr_0_1XLB_LN_res_v3_3_.mat' );
...
projectPath = '~/IMS_project-master';
SURFACTIN_INPUT_PATH = [projectPath '/' 'example/realExp_100831_348_136_12_40hr_0-1XLB_LN/30 ug LN.mzML_dc.mat'];
basicVarPath = [projectPath, '/', 'example/realExp_100831_348_136_12_40hr_0-1XLB_LN/100831_348_136_12_40hr_0_1XLB_LN_vars.mat'];
MPPath = [projectPath, '/', 'example/molecule_profile_neg_v2.csv'];
...
projectPath = '~/IMS_project-master';
pLSAResPath = [projectPath, '/', 'example/realExp_100831_348_136_12_40hr_0-1XLB_LN/res_pLSA_20150403.mat'];
load( pLSAResPath );
[~, idx] = min(AICSPVec);
...
NNMFResPath = [projectPath, '/', 'example/realExp_100831_348_136_12_40hr_0-1XLB_LN/res_NNMF_20150403.mat'];
load( NNMFResPath );
[~, idx] = min(ResSpVec);
