function [ expRec, gridVec ] = exp_all_hypers_grid_search_lf_log_20150126( index )
...
param.linkFunc = 'log';
[lVec, tVec] = meshgrid( lambdaVec_lf_log...
    , thetaVec_lf_log );
...
mkdir( '/lustre/scr/y/h/yharn/all_hypers_grid_search_results_lf_log_20150126' );
resName = ['exp_100831_348_136_12_40hr_0_1XLB_LN_res_' num2str(index) '_.mat' ];
save( ['/lustre/scr/y/h/yharn/all_hypers_grid_search_results_lf_log_20150126/' resName], 'expRec');
