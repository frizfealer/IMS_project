function [ ] = null_models_LF_log_DC_L1()
...
lambda = 1e-32; theta = 1e-32; phi = 0;
param.D_CONSTRAINTS = 'L1';
param.linkFunc = 'log';
[ expRec ] = dictionaryLearning_ADMM_v6( dataCube, [], DTemplate3, [], lambda, theta, phi, aMatrix, BlkDS, [], 'temp2.mat', param );
%%
save( 'null_model_20150111_lf_log_DC_L1.mat', 'expRec' );
end