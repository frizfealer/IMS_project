function [ ] = null_models_LF_ID_DC_L1()
...
[ expRec ] = dictionaryLearning_ADMM_v6( dataCube, [], DTemplate3, [], lambda, theta, phi, aMatrix, BlkDS, [], 'temp1.mat', param );
%%
save( 'null_model_20150111_lf_iden_DC_L1.mat', 'expRec' );
end