...
[ expRec ] = dictionaryLearning_ADMM_v6( dataCube, [], DTemplate3, [], lambda, theta, phi, aMatrix, BlkDS, [], 'temp4.mat', param );
%%
save( 'null_model_20150111_lf_NB_DC_L1.mat', 'expRec' );
end